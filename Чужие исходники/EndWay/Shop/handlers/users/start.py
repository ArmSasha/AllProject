...
async def bot_start(message: types.Message):
    ...
    with open("photos/cartel.jpg", "rb") as cartel:
        if check_new_user(userid) == True:
            ...
            await message.answer_photo(photo=cartel, caption=f"<b>{message.from_user.full_name}, Вас приветствует бот автопродаж Mexican Cartel</b> 🇲🇽\n\n"
            ...
            await message.answer_photo(photo=cartel, caption=f"<b>{message.from_user.full_name}, приветствуем Вас снова</b> 🇲🇽",reply_markup=main_menu())
