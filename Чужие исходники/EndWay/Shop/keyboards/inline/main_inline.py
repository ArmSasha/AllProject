...
def start_menu():
    ...
    start_menu.add(
        InlineKeyboardButton(text="📃 Правила шопа", url="https://telegra.ph/MEXICAN-CARTEL-RULES-04-09"),
...
def payment_menu():
    ...
    payment_menu.add(
        InlineKeyboardButton(text="🥝 Qiwi |💳 карта", callback_data="add_qiwi"),
...
def pay_menu(staff_id, link, bill_id):
    ...
    pay_menu.add(
        ...
        InlineKeyboardButton(text="🧛‍♀️ Скырть", callback_data="hide_buy+{}".format(bill_id)),
...
def support_but():
    ...
    support_but.add(
        InlineKeyboardButton(text="🤵‍♂️ Оператор продаж", url="https://t.me/mexican_cartell"),
        InlineKeyboardButton(text="👨‍⚖️ Администрация шопа", url="https://t.me/mexican_adminbot")
    )
    return support_but
