...
def start_kb():
    ...
    kb1 = KeyboardButton("➡️Купить")
    kb2 = KeyboardButton("🧨Пробный спам")
    kb3 = KeyboardButton("🔎Информация")
    keyboard.add(kb1, kb2).add(kb3)
    return keyboard

def info_kb():
    keyboard = InlineKeyboardMarkup(row_width=2)
    kb = InlineKeyboardButton(text="👨‍💻 Владелец", url="t.me/VelorOfficial")
    kb1 = InlineKeyboardButton(text="🔥 Ссылка на канал", url="t.me/VelorBomberNews")
    keyboard.add(kb).add(kb1)
    return keyboard

def sub_kb():
    keyboard = InlineKeyboardMarkup(row_width=2)
    kb = InlineKeyboardButton(text="🔥 Ссылка на канал", url="t.me/VelorBomberNews")
    keyboard.add(kb)
    return keyboard
...
def flood_type():
    keyboard = InlineKeyboardMarkup(row_width=2)
    kb = InlineKeyboardButton(text="🧨 Пробный спам", callback_data="default_flood")
    ...
    kb4 = InlineKeyboardButton(text="↪️ Назад", callback_data="close_message")
...
def profile_kb():
    ...
    kb2 = InlineKeyboardButton(text="🔰 Ранги", callback_data="rangs")
    kb3 = InlineKeyboardButton(text="➕ Активировать промокод", callback_data="activate_key")
    kb4 = InlineKeyboardButton(
        text="🤝 Партнерская программа", callback_data="partner programm"
    )
    kb5 = InlineKeyboardButton(text="👨‍💻 Владелец", url="t.me/VelorOfficial")
    keyboard.add(kb).add(kb1, kb2).add(kb3).add(kb4).add(kb5)
    return keyboard
...
def flood_mode_kb(_type, bomber):
    keyboard = InlineKeyboardMarkup(row_width=1)
    kb = InlineKeyboardButton(
        text="💡 Обычный", callback_data=f"bomber_mode|classic|{_type}|{bomber}"
    )
    kb1 = InlineKeyboardButton(
