...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        btn_open_dialog = tk.Button(toolbar, text='Add a position', command=self.open_dialog, bg='#d7d8e0', bd=0,
        ...
        self.tree.heading('costs', text='Item of income\expense')
        self.tree.heading('total', text='Sum')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_select = tk.Label(self, text='Item of income\expense:')
        label_select.place(x=50, y=80)
        label_sum = tk.Label(self, text='Sum:')
        ...
        self.combobox = ttk.Combobox(self, values=[u'Income', u'Expenditure'])
...
class DB:
    def __init__(self):
        self.conn = sql.connect('finance.db')
