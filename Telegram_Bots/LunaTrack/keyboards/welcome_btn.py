...
openwebapp = types.ReplyKeyboardMarkup()
openwebapp.add(types.KeyboardButton('Открыть веб страницу', web_app=WebAppInfo(url='http://sadakexl.beget.tech/index.php')))