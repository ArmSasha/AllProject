                ...
                try:
                    if referrer_id:
                        if referrer_id.isdigit() and int(referrer_id) != user_id:
                            ...
                            await bot.send_message(message.from_user.id, """***Привет, с наступающим!🎉

Наша команда хочет пожелать вам успехов, счастья и конечно УДАЧИ в будущем году! 🍀

В честь этого мы хотим разыграть ⭐️Telegram Premium на 3 месяца! Условия и правила вы найдете тут:
📎 https://t.me/anonulsk_news/4***""", parse_mode='Markdown', reply_markup=cont.contest)
